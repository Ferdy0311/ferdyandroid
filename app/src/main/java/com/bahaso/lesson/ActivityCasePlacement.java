...
public class ActivityCasePlacement extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_case_placement);
        ...
        Log.i("placementId" , placementTestId+"");
...
//                }
    ...
    public void showDialog()
    {
        ...
        AlertDialogYesNoSimple yesNoSimpleAlertDialog = new AlertDialogYesNoSimple(ActivityCasePlacement.this,"Lewati Tes Penempatan","Tes penempatan ini hanya sekali. Ketika Anda melewatkan Tes ini Anda akan mulai dari Level 1.","Kembali","Lewati");
//                AlertDialog yesNoSimpleAlertDialog = new AlertDialog(getApplicationContext());
    ...
    {
        txtSkip = (TextView) findViewById(R.id.txtActivityCaseSkip);
...
//                fVidCurr.playVideo();
    ...
    public void getCaseData()
    {
        ...
        final String URL_PLACEMENT_CASE = global.getBaseURLpath() + "placement_test/"+ placementTestId;
        Log.i("URL",URL_PLACEMENT_CASE);
        try {
                        ...
                        public void onResponse(String response) {
                            try {
                                ...
                                if(status.equals("true")) {
                                    ...
                                    JSONArray packetArray = jsonArr.getJSONArray("packets");
                                    String placementTestIdJSON = jsonArr.getString("id");
                                    if(placementTestIdJSON.equals(placementTestId))
                                    {
                                        listCaseFragment = new ArrayList<FragmentBahaso>();
                                        for(int idxPacketArr = 0; idxPacketArr< packetArray.length();idxPacketArr++)
                                        {
                                            JSONArray casesArray =
                                                    packetArray.getJSONObject(idxPacketArr).getJSONArray("cases");
...
//        timerFormatted = dateFormat.format(maxTime);
        ...
        countDownTimer = new CountDownTimer(maxTime+2000,countdownInterval) {
            ...
            public void onTick(long l) {
                ...
                txtCountdownTimer.setText(timerFormatted);
                if(l-1000<1000) {
                    Toast.makeText(ActivityCasePlacement.this, "Times Up", Toast.LENGTH_SHORT).show();
                }
            }
